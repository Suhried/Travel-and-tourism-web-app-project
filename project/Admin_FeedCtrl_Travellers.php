...
<div class="center">
	<h3 class="text">Travellers FeedBack</h3>
	<table class="table table-striped">
		...
		<tbody>
            ...
            <td><a href="controllers/Admin_FeedDismissController.php?id=<?php echo $row['sl']?>.php" class="btn btn-danger">Dismiss</a></td>
		</tbody>
		<?php endforeach;?>
	</table>
		</tbody>
